...
public class telaInserirPessoa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Informe os dados abaixo para inserir um cadastro:");
    ...
    private void botaoInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoInserirActionPerformed
        ...
        if (codigo.equals("") || nome.equals("") || idade.equals("") || email.equals("")){
            ...
            try{
                ...
                boolean i = RegrasNegocio.inserirPessoa(cod2, nome, idade2, email);

                if(i){
                    JOptionPane.showMessageDialog(null, "Cadastro efetuado com sucesso!", "Inserir", 1);
                }else{
